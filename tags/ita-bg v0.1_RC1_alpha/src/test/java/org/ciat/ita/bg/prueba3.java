...
public class prueba3 {
	...
	public static void main(String[] args) {
		...
		String consultaPrueba1 = "select * from georeferenced_records g, SSTN_temp_bad_records s"
			+" where g.id=s.id and s.error='WC' and country is not null and state_province is not null"
			+" and locality is not null group by state_province limit 100";
