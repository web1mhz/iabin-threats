...
public class Shapefile {
	...
	/**
	 * @uml.property  name="featureSource"
	 * @uml.associationEnd  multiplicity="(1 1)"
	 */
	private FeatureSource<SimpleFeatureType, SimpleFeature> featureSource;
	/**
	 * @uml.property  name="connectParameters"
	 * @uml.associationEnd  qualifier="constant:java.lang.String java.net.URL"
	 */
	 ...
	 * 
	 * @param sf
	 *            is the simple feature to get the marker point
	 * @return
	 */
	public static Point getPointForMarker(SimpleFeature sf) {
		...
		if (byX) {
			in = gf.createLineString(new Coordinate[] { new Coordinate(sf.getBounds().getMinX() + difX, 90),
					new Coordinate(sf.getBounds().getMinX() + difX, -90) });
		} else {
			in = gf.createLineString(new Coordinate[] { new Coordinate(180, sf.getBounds().getMinY() + difY),
