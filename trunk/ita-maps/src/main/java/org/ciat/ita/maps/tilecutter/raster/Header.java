...
public class Header {
	...
	/**
	 * @uml.property  name="ncol"
	 */
	private int ncol;
	/**
	 * @uml.property  name="nfil"
	 */
	private int nfil;
	/**
	...
	public void loadFile(BufferedReader reader) throws IOException {
		...
		projection = new WGS84(Double.parseDouble(head.get("xllcorner")), Double.parseDouble(head
				.get("yllcorner")), Double.parseDouble(head.get("cellsize")), Double.parseDouble(head
				.get("cellsize")));
